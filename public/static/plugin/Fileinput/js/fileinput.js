...
(function (factory) {
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<button type="button" class="kv-file-remove {removeClass}" ' + 'title="{removeTitle}">{removeIcon}</button>{dataUrl}\n';
    ...
    FileInput.prototype = {
        ...
        _initZoomButton: function () {
            var self = this,$first, $last,
                frames = self.$preview.find('.file-preview-frame').toArray(), len = frames.length,
                $prev = self.$preview.find('.kv-file-forward'), $next = self.$preview.find('.kv-file-backward'),
            ...
            $first.find('.kv-file-forward').addClass('hide');
		    $last.find('.kv-file-backward').addClass('hide');
