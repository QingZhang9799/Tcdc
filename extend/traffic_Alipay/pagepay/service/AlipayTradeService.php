...
class AlipayTradeService {
	...
	function Refund($builder){
		...
		$response = $this->aopclientRequestExecute ($request);
//		["alipay_trade_refund_response"] => object(stdClass)#1169 (10) {
//		["code"] => string(5) "10000"
//		["msg"] => string(7) "Success"
//		["buyer_logon_id"] => string(11) "151******35"
//		["buyer_user_id"] => string(16) "2088702404599442"
//		["fund_change"] => string(1) "Y"
//		["gmt_refund_pay"] => string(19) "2019-09-28 14:48:32"
//		["out_trade_no"] => string(15) "928532728146033"
//		["refund_fee"] => string(4) "0.01"
//		["send_back_fee"] => string(4) "0.00"
//		["trade_no"] => string(28) "2019092822001499440532287238"
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( dirname ( __FILE__ ).DIRECTORY_SEPARATOR."./../../log/".date ( "Y-m-d" ).".txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
}
