...
function sendSMS($mobile, $randcode, $moban, $Name){
    
    //此处需要替换成自己的AK信息
    $accessKeyId = "LTAI9O9tS94AsMMd";
    $accessKeySecret = "XJ2QUcewBPJWxZKjLSLtHIC9NqCTgA";
    //短信API产品名
    $product = "Dysmsapi";
    //短信API产品域名
    ...
    $request->setTemplateParam("{\"code\":\"$randcode\",\"product\":\"阿里大于\"}");
    //选填-发送短信流水号
