...
class Wechat
{
    ...
    {
        $url = "https https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=".$this->getAccessToken()."&type=TYPE" ;
//        $filepath = 'D:/phpStudy/PHPTutorial/WWW/tcdc/public/static/home/'.'bg_img.jpg';//图片地址自己写
        var_dump(ROOT_PATH) ;
         $file_info = array(
            'filename'=>ROOT_PATH.'public\static\bjnews\images\bangding.png',
